...
<div class="p-6 space-y-6">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow overflow-x-auto">
        <table id="categoryTable" class="min-w-full text-sm">
            ...
            <tbody>
                ...
                <tr data-id="{{ $cat->id }}">
                    ...
                    <td class="px-4 py-2 space-x-2">
                        <button onclick="editCategory({{ $cat->id }})" class="text-blue-600 hover:underline">Edit</button>
...
<div id="categoryModal" class="fixed inset-0 bg-black bg-opacity-50 hidden items-center justify-center z-50">
    <div class="bg-white dark:bg-gray-900 w-full max-w-md p-6 rounded shadow">
        <h2 id="modalTitle" class="text-lg font-semibold mb-4 text-gray-800 dark:text-white">Create Category</h2>
        <form id="categoryForm">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="name" id="catName" class="w-full border border-gray-300 dark:border-gray-600 rounded p-2 dark:bg-gray-800 dark:text-white">
            </div>
...
<script>
$(document).ready(() => $('#categoryTable').DataTable());
...
document.getElementById('categoryForm').addEventListener('submit', function (e) {
    ...
    .catch(err => {
        console.error(err);
        showAlert('Failed to save category.', 'bg-red-500');
    });
});
</script>
@endpush
